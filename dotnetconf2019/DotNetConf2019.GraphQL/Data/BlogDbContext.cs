...
namespace DotNetConf2019.GraphQL.Data
{
    public class BlogDbContext : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer(@"Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=DotNetConf2019;Integrated Security=True;Connect Timeout=30");
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var posts = new Faker<Post>()
                ...
                .RuleFor(p => p.PublishedOn, f => f.Date.PastOffset()) // OffsetDateTime.FromDateTimeOffset(f.Date.PastOffset()))
                .Generate(25);
            ...
            var comments = new Faker<Comment>()
                ...
                .RuleFor(c => c.SubmittedOn, f => f.Date.PastOffset()) //OffsetDateTime.FromDateTimeOffset(f.Date.PastOffset()))
