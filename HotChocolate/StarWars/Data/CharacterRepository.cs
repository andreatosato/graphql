...
namespace StarWars.Data
{
    public class CharacterRepository
    {
        ...
        public IQueryable<Human> GetHumanQueryable()
        {
            return _charactersQuery.AsQueryable().Where(x => x.GetType() == typeof(Human)).Cast<Human>();
        }
